    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    KitInfoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CaseId = table.Column<int>(type: "int", nullable: false),
                    KitBoxCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KitInfos", x => x.KitInfoId);
                    table.ForeignKey(
                        name: "FK_KitInfos_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "CaseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KitInfos_CaseId",
                table: "KitInfos",
                column: "CaseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Patients_CaseId",
                table: "Patients",
                column: "CaseId",
                unique: true);
        }
